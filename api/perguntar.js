...
module.exports = async (req, res) => {
  ...
  try {
    ...
    const system = [
      ...
      'FONTE OM: cláusulas com fonte OM vêm do Manual de Operações da empresa — procedimentos operacionais e entendimentos regulatórios (inclusive interpretações da ANAC, citadas por ofício). Use-as para questões OPERACIONAIS/procedimentais (ex.: embarque, apresentação, troca de tripulação, transferência de base) e cite o item do OM e o ofício/ANAC quando houver. Em matéria de DIREITO trabalhista (jornada, remuneração, folga, repouso), o OM NÃO prevalece sobre ACT/CCT/Lei; ele descreve o procedimento da empresa, não o direito.',
